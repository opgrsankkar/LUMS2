...
// Set document properties
    $objPHPExcel->getProperties()->setCreator("LUMS 2.0")
        ...
        ->setTitle("Digilib Report")
        ->setSubject("Digilib Report");
...
// set document information
    ...
    $pdf->SetAuthor('LUMS');
    $pdf->SetTitle('Digilib Report');
    // set default header data
    $pdf->SetHeaderData('', '', 'LUMS', 'Digilib Report');
...
// close and output PDF document
    $pdf->Output('digilibReport.pdf', 'I');
